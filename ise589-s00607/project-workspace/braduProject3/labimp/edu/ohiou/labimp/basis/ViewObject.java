 ...
 */
  ...
  static {
    try {
      ...
      System.out.println(
      "Properties loaded from ViewObject resource file implanner.properties");
    }
    catch (Exception ex) {
      System.err.println(
    ...
    try {
      ...
      properties.load(new FileInputStream(propertyFile));
      System.out.println(
      "Properties loaded from current folder file implanner.properties");
    }
    catch (Exception ex) {
      System.err.println(
...
//    Toolkit.getDefaultToolkit().c
//    BufferedImage  imIcon = (BufferedImage) new ImageIcon (
//        ViewObject.class.getResource("branka-AHS-junior.jpg")).getImage().
//        getScaledInstance(-1,20,Image.SCALE_SMOOTH);
    BufferedImage  viewim = (BufferedImage) new ImageIcon (
        ViewObject.class.getResource("ViewObject.gif")).getImage().
        getScaledInstance(-1,20,Image.SCALE_SMOOTH);
    if (canvas instanceof Draw2DPanel) {
...
//        panel2D.addImage(imIcon, transform);
        ...
        panel2D.addImage(viewim, transform);
        
//      panel2D.addImage(new ImageIcon (
//          ViewObject.class.getResource("branka-AHS-junior.jpg")).getImage().
//          getScaledInstance(-1,20,Image.SCALE_SMOOTH), transform);
