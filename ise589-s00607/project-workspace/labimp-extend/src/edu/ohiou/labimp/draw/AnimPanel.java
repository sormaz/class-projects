...
import edu.ohiou.labimp.draw.AnimApplet;
...
public class AnimPanel extends JPanel implements Drawable3D {
	...
	public AnimPanel(Drawable3D target) {
		this(target, (AnimApplet) ((Viewable)target).getApplet(), DEFAULT_VIEW_POINT, SOLID);
	}
...
//	}
	 ...
	 * (non-Javadoc)
	 * @see edu.ohiou.labimp.basis.Viewable#toToolTipString()
	 */
