...
import edu.ohiou.labimp.basis.Point2DComparator;
...
public class DrawWFPanel extends JPanel implements DrawableWF {
...
private HashMap fillMap = new HashMap();
	...
	public DrawWFPanel(DrawableWF inTarget) {
		this(
			inTarget,
			(DrawWFApplet) ((Viewable)inTarget).getApplet(),
			DEFAULT_VIEW_POINT,
			DEFAULT_SCALE);
	}
