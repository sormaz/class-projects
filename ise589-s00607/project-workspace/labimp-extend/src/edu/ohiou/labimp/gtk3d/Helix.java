...
public class Helix extends CurveSegment {
	...
	/* (non-Javadoc)
	 * @see edu.ohiou.labimp.gtk3d.CurveSegment#getEndPoint()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.ohiou.labimp.gtk3d.CurveSegment#getStartPoint()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.ohiou.labimp.gtk3d.CurveSegment#getTangent(javax.vecmath.Point3d)
	 */
...
//				+ totalAngle);
	...
	/* (non-Javadoc)
	 * @see edu.ohiou.labimp.gtk3d.CurveSegment#swap()
	 */
	...
	public static void main(String[] args) {
		Helix h = new Helix();
		h.setApplet(new DrawWFApplet (h));
		h.display();
		// TODO Auto-generated method stub
