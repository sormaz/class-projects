...
public class Polyhedron extends ImpObject {
	...
	public boolean isCurveInside (LineSegment line) {
		return isPointInside (line.getStartPoint()) && 
		isPointInside (line.getEndPoint());
	}
	...
	public boolean isCurveInside (Arc arc) {
		return isPointInside (arc.getStartPoint()) && 
		isPointInside (arc.getEndPoint());
	}
	...
	public static void main(String[] args) {
		...
		polyhedron.setApplet(new DrawWFApplet(polyhedron));
