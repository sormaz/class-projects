...
public class Polygon3d extends ImpObject {
	...
	public void createPolygon() {
		...
		panel.getApplet().appletFrame.dispose();
	...
	public static Polygon3d staticCreatePolygon() {
		...
		staticPanel.setApplet(new GUIApplet(staticPanel));
		staticPanel.display("Polygon3d Creation Panel from static method");
		while ((guiObject == null) || !((Polygon3d) guiObject).isValid()) {
			// ImpObject.doNothing(staticPanel,"polygon is null");
		}
		staticPanel.getApplet().appletFrame.dispose();
		staticPanel.getApplet().destroy();
	...
	public void init() {
		...
		((ViewPanel) panel).setApplet(this.getApplet());
		guiObject = this;
	...
	public static void main(String[] args) {
		...
		poly2.setApplet(new DrawWFApplet(poly2));
	...
	static class Polygon3dPanel extends ViewPanel {
		...
		public void init() {
			...
			colorButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					guiObject.setColor(JColorChooser.showDialog(
						Polygon3dPanel.this,
						"Select a color",
						Color.black));
				...
				showPolygonButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if (object != null) {
							...
							Polygon3dPanel.this.getApplet().appletFrame
								.dispose();
							Polygon3dPanel.this.getApplet().destroy();
							object.setApplet(new DrawWFApplet(object));
