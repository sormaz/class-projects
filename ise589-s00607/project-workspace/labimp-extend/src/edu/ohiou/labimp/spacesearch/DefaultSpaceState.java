...
abstract public class DefaultSpaceState extends ImpObject implements Searchable {
  ...
  static {
	  ...
	  getProperty("edu.ohiou.labimp.spacesearch.DefaultSpaceState.printIndex", "No").
  ...
  public DefaultSpaceState () {
	...
	/**
	 *
	 *    This method returns memebr variable parent
	 *   
...
//    return null;
  ...
  if (s.currentState.equals(s.goalState) ) {
    s.hasReachedGoal = true;
    s.goalState = s.currentState;
    ((Viewable)s.goalState).setColor (SpaceSearcher.GOAL_COLOR);
    return true;
//    return goalState;
  }
  return false;
