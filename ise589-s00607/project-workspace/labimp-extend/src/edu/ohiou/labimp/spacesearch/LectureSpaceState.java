...
public class LectureSpaceState extends DefaultSpaceState {
	...
	/* (non-Javadoc)
	 * @see edu.ohiou.labimp.spacesearch.DefaultSpaceState#setSearchTypes()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.ohiou.labimp.spacesearch.Searchable#makeNewStates()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.ohiou.labimp.spacesearch.Searchable#equals(edu.ohiou.labimp.spacesearch.Searchable)
	 */
