...
public class Farmer extends DefaultSpaceState {
	...
	public Collection makeNewStates() {
		...
		Farmer moveFarmer = new Farmer(
			...
			cabbageLocation,
			this);
    moveFarmer.setColor(SpaceSearcher.OPEN_COLOR);
		Farmer moveFarmerWolf = new Farmer(
			...
			cabbageLocation,
			this);
    moveFarmerWolf.setColor(SpaceSearcher.OPEN_COLOR);
		Farmer moveFarmerGoat = new Farmer(
			...
			cabbageLocation,
			this);
    moveFarmerGoat.setColor(SpaceSearcher.OPEN_COLOR);
		Farmer moveFarmerCabbage = new Farmer(
			...
			!cabbageLocation,
			this);
    moveFarmerCabbage.setColor(SpaceSearcher.OPEN_COLOR);
		if (moveFarmer.safe())
