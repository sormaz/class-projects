...
public class InvalidIntersectionException extends GeometryException {

/**
 * Constructor that takes string description of the cause
 */
  public InvalidIntersectionException(String s) {
    super (s);
  }
	...
	public void showException() {
	  System.out.println("InvalidIntersectionException: " + getMessage());
	}
}